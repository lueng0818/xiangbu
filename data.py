...
ATTRIBUTES = {
    ...
    "士": {"五行": "金", "特質": "一人之下, 文昌", "身體": "肺大腸皮膚鼻, 頭部", "適合": "大吉大利, 投資運佳"},
    "仕": {"五行": "金", "特質": "帶權名聲, 有威嚴", "身體": "肺大腸皮膚鼻, 頭部", "適合": "大吉大利, 投資運佳"},
    "包": {"五行": "水", "特質": "人緣佳, 小桃花", "身體": "腎膀胱骨耳婦科", "適合": "智慧型, 流動事業"},
    "炮": {"五行": "水", "特質": "想飛想改變, 好高騖遠", "身體": "腎膀胱骨耳婦科", "適合": "智慧型, 流動事業"},
}

# 【新增】棋子符號學詳細解讀 (Archetypes)
PIECE_SYMBOLISM = {
    "將帥": {
        "role": "👑 唯我獨尊的領導者",
...
FIVE_ELEMENTS_DETAILS = {
    "木": {"emotion": "怒", "organs": "肝、膽", "psycho_msg": "心裡積壓怒氣，報復心。", "physio_msg": "睡眠差，肩頸僵硬。", "advice": "少生氣，多伸展。"},
    ...
    "金": {"emotion": "憂", "organs": "肺、大腸", "psycho_msg": "講義氣但自以為是，悲觀。", "physio_msg": "呼吸道過敏，便秘。", "advice": "多深呼吸。"},
    "水": {"emotion": "恐", "organs": "腎、膀胱", "psycho_msg": "聰明但用腦過度，驚疑。", "physio_msg": "內分泌，婦科，腰痠。", "advice": "早睡補腎氣。"}
}

# 位置定義
POSITION_MAP = {
    1: {"名稱": "中 (人格)", "關係": "核心/當下", "部位": "軀幹", "意義": "核心癥結、當事人狀態。"},
    4: {"名稱": "上 (天格)", "關係": "根源/貴人", "部位": "頭部", "意義": "運勢來源、長輩緣。"},
    5: {"名稱": "下 (地格)", "關係": "結果/財庫", "部位": "下肢", "意義": "產出、結局、不動產。"},
    2: {"名稱": "左 (人際)", "關係": "平輩/助力", "部位": "👉 右半身", "意義": "鏡像原理：右側身體。"},
    3: { "名稱": "右 (人際)", "關係": "平輩/助力", "部位": "👈 左半身", "意義": "鏡像原理：左側身體。"}
}

# 能量調理建議
ENERGY_REMEDIES = {
    "Red": {"status": "🔥 血氣旺", "advice": "去踩草地，洩火氣。"},
    "Black": {"status": "💧 氣血旺", "advice": "多曬太陽，補陽氣。"}
}
