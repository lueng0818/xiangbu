...
# 棋子符號學 (Archetypes)
PIECE_SYMBOLISM = {
    "將帥": {"role": "👑 唯我獨尊的領導者", "self": "主見強，掌控欲，能量強但孤獨。", "love": "對方強勢主導，不宜硬碰硬。", "career": "老闆命，適合創業。", "health": "頭部壓力大、神經傳導。"},
    "士仕": {"role": "📜 足智多謀的幕僚", "self": "智慧高，紅仕心軟，黑士防備。", "love": "關係不錯，注意口角。", "career": "主管格，靠口才腦袋 (文昌)。", "health": "呼吸道不順、腸胃敏感。"},
    "象相": {"role": "🛡️ 穩重的守護者", "self": "心態穩重，喜靜不喜動，有佛緣。", "love": "配對佳，情緒起伏大。", "career": "不動產，穩定財。", "health": "火氣大，易發福。"},
    "車俥": {"role": "🏎️ 衝鋒陷陣的戰將", "self": "衝勁足，拼命三郎，說話直。", "love": "對方強勢愛管人，易鬥嘴。", "career": "大好大壞，適合業務或老闆。", "health": "肝火旺，易抽筋。"},
    "馬傌": {"role": "🐎 奔波的公關/忙碌者", "self": "忙碌，人際公關強。勞碌命。", "love": "適合有點距離，太黏易磨擦。", "career": "動才有財。", "health": "筋骨痠痛。"},
    "包炮": {"role": "💣 善變的謀略家", "self": "想改變，心大，點子多。", "love": "桃花星，適合隔山打牛 (距離美)。", "career": "靠腦袋，時效性/流動性生意。", "health": "內分泌、婦科、神經緊繃。"},
    "兵卒": {"role": "🧱 踏實的執行者", "self": "認真踏實，講信用，穩重。", "love": "最穩定的牌，認定就不變心。", "career": "現金財，需強迫儲蓄。", "health": "消化慢，思慮多傷脾胃。"}
}
...
FIVE_ELEMENTS_DETAILS = {
    "木": {"emotion": "怒", "organs": "肝、膽、筋、目", "psycho_msg": "心裡積壓怒氣，報復心。", "physio_msg": "睡眠差，肩頸僵硬。", "advice": "少生氣，多伸展。"},
    ...
    "水": {"emotion": "恐", "organs": "腎、膀胱", "psycho_msg": "用腦過度，驚疑。", "physio_msg": "內分泌，婦科，腰痠。", "advice": "早點睡覺補腎氣。"}
}
...
POSITION_MAP = {
    ...
    2: {"名稱": "左 (右側)", "關係": "平輩/助力", "部位": "👉 右半身", "意義": "鏡像原理：盤面左邊對應身體右側。人際：競爭/合作。"},
    3: {"名稱": "右 (左側)", "關係": "平輩/助力", "部位": "👈 左半身", "意義": "鏡像原理：盤面右邊對應身體左側。人際：競爭/合作。"}
}
